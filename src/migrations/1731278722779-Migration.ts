...
export class Migration1731278722779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order_state" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "type" character varying(11) NOT NULL, CONSTRAINT "PK_88c450fe640950274892dbda5e4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "delivery_address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "address" character varying NOT NULL, "rank" integer NOT NULL, "userId" uuid, CONSTRAINT "PK_00581098daef1f881bb3d17a0cd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "genderId" uuid, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "orderDate" TIMESTAMP NOT NULL, "orderStateId" uuid, "userId" uuid, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "count" integer NOT NULL, "orderId" uuid, "productId" uuid, CONSTRAINT "PK_539ede39e518562dfdadfddb492" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "clothing_size" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "type" character varying(3) NOT NULL, CONSTRAINT "PK_44fff2013dfebb907e06e266a5c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_clothing_size" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "clothingSizeId" uuid, "productId" uuid, CONSTRAINT "PK_dfb6b22f6841dbd901cd8d6427b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "image" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "url" character varying NOT NULL, CONSTRAINT "PK_d6db1ab4ee9ad9dbe86c64e4cc3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_image" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "rank" integer NOT NULL, "productId" uuid, "imageId" uuid, CONSTRAINT "PK_99d98a80f57857d51b5f63c8240" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "price" integer NOT NULL, "quantity" integer NOT NULL, "name" character varying NOT NULL, "view" integer NOT NULL, "description" character varying NOT NULL, "categoryId" uuid, "genderId" uuid, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "gender" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "type" character varying(6) NOT NULL, CONSTRAINT "PK_98a711129bc073e6312d08364e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "admin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "username" character varying NOT NULL, "password" character varying NOT NULL, CONSTRAINT "PK_e032310bcef831fb83101899b10" PRIMARY KEY ("id"))`);
