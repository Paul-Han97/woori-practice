...
export class Migration1731278722779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "orderId" uuid, "productId" uuid, CONSTRAINT "PK_539ede39e518562dfdadfddb492" PRIMARY KEY ("id"))`);
