...
export class Migration1731278722779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying, "updatedDate" TIMESTAMP DEFAULT now(), "orderDate" TIMESTAMP NOT NULL, "orderStateId" uuid, "userId" uuid, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
