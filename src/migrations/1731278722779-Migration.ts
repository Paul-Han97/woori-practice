...
export class Migration1731278722779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdUser" character varying DEFAULT 'SYSTEM', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedUser" character varying DEFAULT 'SYSTEM', "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "price" integer NOT NULL, "quantity" integer NOT NULL, "name" character varying NOT NULL, "view" integer NOT NULL, "categoryId" uuid, "genderId" uuid, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
